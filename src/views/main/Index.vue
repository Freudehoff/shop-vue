                    ...
                    <div class="col-lg-7 col-md-8 col-sm-10">
                        <div class="newsLetter-popup__content mb-4">
                            ...
                            <form action="#0" class="newsLetter-popup__subscrib-form">
                                ...
                                <div class="form-group "><input type="checkbox" id="html"> <label for="html"> By
                                    providing
                 ...
                 "fade": false, "pauseOnHover": false}'>
                    ...
                    <div class="slide">
                        <div class="contant-box position-relative">
                            ...
                            <img class="bg-img hundread-vh" src="../../assets/images/home-three/home-3-bg-2.jpg"
                                 alt="image">
                    ...
                    <div class="row mt--30">
                        <div class="col-lg-6 h-100 mt-30">
                            <a href="shop-grid.html" class="catagory-single one home3cat">
                                <img src="../../assets/images/home-three/cat-1.png" alt="#"
                            ...
                            <ul class="nav three nav-pills justify-content-center" id="pills-tab-two" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active"
                                            ...
                                            aria-controls="pills-best-sellers" aria-selected="true"> Best Sellers
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link"
                                            ...
                                            aria-controls="pills-new-arrivals" aria-selected="false"> New Arrivals
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-top-rated-tab"
                                            data-bs-toggle="pill" data-bs-target="#pills-top-rated" type="button"
                                            role="tab"
                                            aria-controls="pills-top-rated" aria-selected="false"> Top Rated
                                    </button>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="catagory-slider-three">
                                        ...
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="../../assets/images/home-three/products-1.jpg"
                                                         class="first-img"
                                                         alt=""/>
                                                ...
                                                <div class="products-grid-one__badge-box"> <span
                                                    ...
                                                    class="bg_black badge discount">-40%</span></div>
                                                <a
                                                    href="cart.html" class="addcart btn--primary style2"> Add To
                                                    Cart </a>
                                                <div class="products-grid__usefull-links">
                                                    <ul>
                                                        <li><a href="wishlist.html"> <i class="flaticon-heart"> </i>
                                                            <span>
                                                                wishlist</span> </a></li>
                                    ...
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="../../assets/images/home-three/products-3.jpg"
                                                         class="first-img"
                                                         alt=""/>
                                ...
                                <div class="catagory-slider-three">
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="../../assets/images/home-three/productss2-1.jpg"
                                                         class="first-img"
                                                         alt=""/>
                                ...
                                <div class="catagory-slider-three">
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="../../assets/images/home-three/productss3-1.jpg"
                                                         class="first-img"
                                                         alt=""/>
                                    ...
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="../../assets/images/home-three/productss3-3.jpg"
                                                         class="first-img"
                                                         alt=""/>
                            ...
                            <div class="video-main-box position-relative">
                                <div class="video-two__img"
                                    ...
                                    <div class="icon wow zoomIn animated animated" data-wow-delay="300ms"
                                        ...
                                        <a class="video-popup" title="Video Gallery" href=""> <i
                                            class="flaticon-play"></i>
                                        </a></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="video-two__content">
                                <div class="video-two__content-inner">
                                    ...
                                    <div class="text wow fadeInUp animated">
                                        <p>Credibly fabricate out of-the-boxn twice relationshi after empowered
                                            alignments.
                                            Completely band productivate client-based sources before enabled best
                                            practices.
                                    ...
                                    <div class="btn-box wow fadeInUp animated"><a href="shop-grid.html"
                                                                                  class="btn--primary style2">Discover
                                        More</a></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="products-three__inner">
                                <ul>
                                    ...
                                    <li class="products-three-single wow fadeInUp animated">
                                        <div class="products-three-single-img">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="../../assets/images/home-three/productss2-hover-2.png"
                                                     class="first-img"
                                                     alt=""/>
                                                <img src="../../assets/images/home-three/productss2-2.jpg" alt=""
                                                     class="hover-img"/>
                                    ...
                                    <li class="products-three-single wow fadeInUp animated">
                                        <div class="products-three-single-img">
                                            ...
                                            <div class="products-grid__usefull-links">
                                                <ul>
                                                    <li><a href="#0"> <i class="flaticon-heart"> </i>
                                                        <span> wishlist</span>
                                                    </a></li>
                                                    <li><a href="#0"> <i class="flaticon-left-and-right-arrows"></i>
                                                        <span>
                                    ...
                                    <li class="products-three-single wow fadeInUp animated">
                                        <div class="products-three-single-img"><a href="shop-details-3.html"
                                                                                  class="d-block"> <img
                                            src="../../assets/images/home-three/productss3-4.jpg"
                                            alt=""/>
                                        </a> <a href="cart.html" class="addcart btn--primary style2">
                                            Add To Cart </a>
                                            <div class="products-grid__usefull-links">
                            ...
                            <div class="col-md-6 wow fadeInUp animated">
                                <div class="products-cetagory-three__single">
                                    ...
                                    <div class="products-cetagory-three__single-content "><span>Puma Hot Deal</span>
                                        <h2>2022 Shoes</h2>
                                        <div class="text">
                                            <p>Enable interoperable channels via turnkey <br> market models...</p>
                                        </div>
                                        <div class="btn-box"><a href="shop-grid-left-sidebar.html">Explore Items</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center justify-content-xl-start justify-content-center">
                                <div class="col-xl-4 col-md-7">
                                    <div
                                        ...
                                        <p>Continually enhance long-term don high impact niche markets whereas user
                                            centric
                ...
                <div class="container auto-container">
                    <div class="row mt--30">
                        ...
                        <div class="col-xxl-3 col-md-6 mt-30 wow fadeInUp animated " data-wow-delay="0.5s">
                            <div class="core-features__box d-flex me-0"><span class="one"></span> <span
                                class="two"></span>
                                ...
                                <div class="review-one__single-review">
                                    <div class="review-one__single-content">
                                        ...
                                        <div class="review-one__review-text">
                                            <p> “Quickly explot worldwide leadership long-term high-impact "outside the
                                                box
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-xl-4 col-lg-4 col-sm-6 wow fadeInUp animated">
                            <div class="blog-three__single mt-30"><a href="blog-single.html"
                                                                     class="blog-three__single-img d-block"> <img
                                src="../../assets/images/blog/blog-v3-2.jpg"
                                alt=""/> </a>
                                <div class="blog-three__single-content text-center"><span>Vendora Style</span>
                        ...
                        <div class="col-xl-4 col-lg-4 col-sm-6 wow fadeInUp animated">
                            <div class="blog-three__single mt-30"><a href="blog-single.html"
                                                                     class="blog-three__single-img d-block"> <img
                                src="../../assets/images/blog/blog-v3-3.jpg"
                                alt=""/> </a>
                                <div class="blog-three__single-content text-center"><span>Vendora Style</span>
                                    <h4><a href="blog-single.html">What men's shoes will be in fashion in the
                                        spring </a>
                                    </h4>
                                    <div class="btn-box"><a href="blog-single.html">Read More</a></div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="gallery-two__slider "><a href="../../assets/images/home-three/gallery-v2-img1.jpg"
                                                                 class="gallery-two__single"> <img
                                src="../../assets/images/home-three/gallery-v2-img1.jpg"
